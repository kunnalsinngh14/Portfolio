...
* **Sectional Design:**
  ...
  - **Certificates:** Clean, verified link rows for academic achievements.

## 🛠️ Technical Implementation

- **CSS-in-HTML:** Utilizes Tailwind Play CDN for rapid, utility-first styling.
- **Theme Engine:** Pure JavaScript logic to toggle `.dark` classes and sync with `localStorage`.
- **Animations:** Custom CSS keyframes for "Fade-In-Up" reveals and cursor pulses.
- **Icons:** Integrated FontAwesome 6.4 for scalable vector graphics.
- **Typography:** Pairs *Space Grotesk* (Headings) with *Inter* (Body) via Google Fonts.

## 📂 File Structure
This is a lightweight, optimized project consisting of a single core file for maximum portability and load speed:
```text
Portfolio/
